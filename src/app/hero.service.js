...
var HeroService = (function () {
    ...
    HeroService.prototype.create = function (name) {
        return this.http.post(this.heroesUrl, JSON.stringify({ name: name }), { headers: this.headers })
            .toPromise().then(function (hero) { return hero.json().data; }).catch(this.handleError);
    };
    ...
    HeroService.prototype.getHeroes = function () {
        ...
        return this.http.get(this.heroesUrl).toPromise().then(function (response) { console.log(response); return response.json().data; }).catch(this.handleError);
    };
    HeroService.prototype.handleError = function (error) {
        console.error('moot loi say ra', error);
